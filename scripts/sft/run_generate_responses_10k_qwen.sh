#!/bin/bash
# ============================================================================
# Generate teacher responses: Qwen2.5-7B-Instruct on mixed_math_code_10k
# ============================================================================
# Usage: bash scripts/sft/run_generate_responses_10k_qwen.sh
#
# This script:
...
PORT=30000
DP_SIZE=8
SERVER_LOG="/tmp/sglang_server_responses_10k_qwen.log"
