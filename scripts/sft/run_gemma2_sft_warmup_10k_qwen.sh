#!/bin/bash
# ============================================================================
# SFT gemma-2-2b-it on sft_warmup_10k_qwen dataset (8723 samples)
...
CONFIG_FILE="${SCRIPT_DIR}/gemma2_sft_warmup_10k_qwen.yaml"
LOG_FILE="${SCRIPT_DIR}/gemma2_sft_warmup_10k_qwen.log"
