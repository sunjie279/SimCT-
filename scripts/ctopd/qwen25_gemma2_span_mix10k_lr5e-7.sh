#!/bin/bash
# Cross-Tokenizer On-Policy Distillation on Mixed Math+Code 30K
# Teacher: Qwen2.5-7B-Instruct  ->  Student: gemma-2-2b-it
...
OPTS+=" --num_epochs 1"
OPTS+=" --save_path ${OUTPUT_PATH}/qwen25-gemma2-span-mix10k-5e-7"
OPTS+=" --bf16 True"
OPTS+=" --gradient_checkpointing True"
OPTS+=" --enable_sleep True"

# ============ ModelArguments ============
OPTS+=" --student_name_or_path ${MODEL_PATH}/gemma2-2b-sft-warmup-10k-qwen-lr2e-6/checkpoint-80"
