...
# Teacher: Phi-4-mini-instruct  ->  Student: gemma-2-2b-it (SFT warmup on phi4)
...
OPTS+=" --num_epochs 1"
OPTS+=" --save_path ${OUTPUT_PATH}/phi4-gemma2-span-mix10k-5e-7"
OPTS+=" --bf16 True"
OPTS+=" --gradient_checkpointing True"
OPTS+=" --enable_sleep True"

# ============ ModelArguments ============
OPTS+=" --student_name_or_path ${MODEL_PATH}/gemma2-2b-sft-warmup-10k-phi4-lr2e-6/checkpoint-20"
OPTS+=" --teacher_name_or_path ${MODEL_PATH}/Phi-4-mini-instruct"
...
OPTS+=" --teacher_context_length 16384"
